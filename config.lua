...
Config.NPCJobEarnings             = {min = 400, max = 1200}
...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = 890.8946, y = -152.7831, z = 76.9427},
	...
	VehicleSpawnPoint = {
		Pos     = {x = 901.7977, y = -144.521, z = 76.62558},
	...
	VehicleDeleter = {
		Pos   = {x = 897.7525, y = -183.8344, z = 72.78238},
	...
	TaxiActions = {
		Pos   = {x = 906.8701, y = -155.3447, z = 74.14727},
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 20, Rotate = true
	},
	...
	Cloakroom = {
		Pos     = {x = 897.4421, y = -171.6753, z = 0.6826},
		Size    = {x = 1.0, y = 1.0, z = 1.0},
		Color   = {r = 204, g = 204, b = 0},
		Type    = 21, Rotate = true
	}
